...
/**
 * Test case for class OsAmazonAffiliate\OsAmazonAffiliate\Controller\ProductsController.
 *
...
class ProductsControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \OsAmazonAffiliate\OsAmazonAffiliate\Controller\ProductsController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('OsAmazonAffiliate\\OsAmazonAffiliate\\Controller\\ProductsController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllProductssFromRepositoryAndAssignsThemToView()
	{
		...
		$productsRepository = $this->getMock('OsAmazonAffiliate\\OsAmazonAffiliate\\Domain\\Repository\\ProductsRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$products = new \OsAmazonAffiliate\OsAmazonAffiliate\Domain\Model\Products();
	...
	public function createActionAddsTheGivenProductsToProductsRepository()
	{
		...
		$productsRepository = $this->getMock('OsAmazonAffiliate\\OsAmazonAffiliate\\Domain\\Repository\\ProductsRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenProductsInProductsRepository()
	{
		...
		$productsRepository = $this->getMock('OsAmazonAffiliate\\OsAmazonAffiliate\\Domain\\Repository\\ProductsRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenProductsFromProductsRepository()
	{
		...
		$productsRepository = $this->getMock('OsAmazonAffiliate\\OsAmazonAffiliate\\Domain\\Repository\\ProductsRepository', array('remove'), array(), '', FALSE);
